<div class="content-wrapper" style="background:#e9f3f2; min-height:100vh; padding:35px 25px;">
  ...
  <div class="card border-0 shadow-sm" style="border-radius:14px; overflow:hidden;">
    <div class="card-header text-white" 
      ...
      <i class="fas fa-tree me-1"></i> Form Edit Data Fasilitas
    </div>

    <div class="card-body" style="padding:30px;">
      <form action="<?= site_url('fasilitas/update/' . $fasilitas->id_fasilitas) ?>" method="post">
          ...
          <div class="col-md-8">
            ...
            <div class="mb-4">
              ...
              <div class="form-text text-muted mt-2" style="font-size:13px;">
                <i class="fas fa-info-circle me-1"></i>Edit nama fasilitas yang tersedia di wisata
              </div>
            </div>
            ...
            <div class="alert alert-info border-0 mt-4" style="background:#e3f2fd; border-radius:10px; border-left:4px solid #2196f3;">
              <div class="d-flex align-items-center">
                ...
                <div>
                  ...
                  <small class="text-muted d-block">Pastikan nama fasilitas belum digunakan oleh data lain.</small>
            ...
            <div class="alert alert-light border-0 mt-3" style="background:#f8f9fa; border-radius:10px; border-left:4px solid #6c757d;">
              <div class="d-flex align-items-center">
                ...
                <div>
                  <small class="fw-bold text-dark">Contoh Fasilitas:</small>
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const originalValue = namaFasilitasInput.value.trim();
  ...
  form.addEventListener('submit', function(e) {
    ...
    if (namaFasilitas === originalValue) {
      e.preventDefault();
  ...
  if (namaFasilitasInput.value.trim() !== originalValue) {
    namaFasilitasInput.style.borderLeft = '4px solid #ffc107';
  }
});
</script>