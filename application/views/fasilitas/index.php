<div class="content-wrapper" style="background:#e9f3f2; min-height:100vh; padding:35px 25px;">
  ...
  <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap">
    <h4 style="font-weight:600; color:#0e3c38; margin-bottom:10px;">
      <i class="fas fa-tree me-2"></i>Daftar Fasilitas Wisata Magelang
    </h4>
  ...
  <div class="card border-0 shadow-sm" style="border-radius:14px; overflow:hidden;">
    <div class="card-header text-white" 
      ...
      <i class="fas fa-list me-1"></i> Data Fasilitas Wisata
      <span class="badge bg-light text-dark ms-2">
        <?= isset($total_rows) ? $total_rows : count($fasilitas) ?> Data
      </span>
    </div>
        ...
        <table class="table align-middle mb-0" style="color:#0e3c38; font-size:14px;">
          <thead style="background:#165b57; color:#e8fffb; font-weight:500;">
            <tr class="text-center">
              ...
              <th style="padding:12px 8px;">Nama Fasilitas</th>
          ...
          <tbody>
              ...
              ?>
                <tr style="transition:0.25s;" 
                  ...
                  <td style="padding:12px 8px; font-weight:600; color:#0e3c38;">
                    <i class="fas fa-check-circle me-2 text-success"></i><?= html_escape($f->nama_fasilitas) ?>
                  </td>
                  <td class="text-center" style="padding:12px 8px;">
                    <div class="btn-group" role="group">
                      <a href="<?= site_url('fasilitas/edit/'.$f->id_fasilitas) ?>" 
                         class="btn btn-sm" 
                         style="background:#ffc107; color:#000; border-radius:6px; margin-right:4px;"
                         data-bs-toggle="tooltip" title="Edit">
                        <i class="fas fa-edit"></i>
                      </a>
                      <a href="<?= site_url('fasilitas/delete/'.$f->id_fasilitas) ?>" 
                         class="btn btn-sm" 
                         style="background:#dc3545; color:white; border-radius:6px;"
                         data-bs-toggle="tooltip" title="Hapus"
                         onclick="return confirm('Yakin ingin menghapus fasilitas <?= html_escape($f->nama_fasilitas) ?>?')">
            ...
            <?php else: ?>
              <tr>
                <td colspan="3" class="text-center py-5 text-muted" style="background:#f8faf9;">
