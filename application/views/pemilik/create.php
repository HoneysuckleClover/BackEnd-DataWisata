<div class="content-wrapper" style="background:#e9f3f2; min-height:100vh; padding:35px 25px;">
  ...
  <div class="card border-0 shadow-sm" style="border-radius:14px; overflow:hidden;">
    <div class="card-header text-white" 
      ...
      <i class="fas fa-user-circle me-1"></i> Form Tambah Data Pemilik
    </div>
    ...
    <div class="card-body" style="padding:30px;">
      <form action="<?= base_url('/pemilik/save') ?>" method="post">
          ...
          <div class="col-md-6">
            <div class="mb-4">
              <label for="nama_pemilik" class="form-label" style="font-weight:600; color:#0e3c38; margin-bottom:8px;">
                <i class="fas fa-user me-1 text-muted"></i>Nama Pemilik <span class="text-danger">*</span>
              </label>
              <input type="text" 
                     class="form-control" 
                     id="nama_pemilik" 
              ...
              <div class="form-text text-muted" style="font-size:12px;">
                Masukkan nama lengkap pemilik wisata
              </div>
            </div>
          </div>
          <div class="col-md-6">
            <div class="mb-4">
              <label for="nik_pemilik" class="form-label" style="font-weight:600; color:#0e3c38; margin-bottom:8px;">
                <i class="fas fa-id-card me-1 text-muted"></i>NIK <span class="text-danger">*</span>
              </label>
              <input type="text" 
                     class="form-control" 
                     id="nik_pemilik" 
          ...
          <div class="col-md-6">
            <div class="mb-4">
              <label for="no_telp" class="form-label" style="font-weight:600; color:#0e3c38; margin-bottom:8px;">
                <i class="fas fa-phone me-1 text-muted"></i>No. Telepon <span class="text-danger">*</span>
              </label>
              <input type="text" 
                     class="form-control" 
                     id="no_telp" 
        ...
        <div class="alert alert-info border-0" style="background:#e3f2fd; border-radius:10px; border-left:4px solid #2196f3;">
          <div class="d-flex align-items-center">
            ...
            <div>
              ...
              <small class="text-muted d-block">Jika NIK tidak diisi, sistem akan membuat NIK otomatis.</small>
            </div>
          </div>
        </div>
