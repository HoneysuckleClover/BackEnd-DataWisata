<div class="content-wrapper" style="background:#e9f3f2; min-height:100vh; padding:35px 25px;">
  ...
  <div class="card border-0 shadow-sm" style="border-radius:14px; overflow:hidden;">
    <div class="card-header text-white" 
      ...
      <i class="fas fa-plus me-1"></i> Form Tambah Data Wisata
    </div>

    <div class="card-body" style="padding:30px;">
      <form method="post" action="<?= site_url('wisata/save') ?>">
        <div class="row">
          <!-- Kolom Kiri -->
          <div class="col-md-6">
            <!-- Nama Wisata -->
          ...
          <div class="col-md-6">
              ...
              <select name="id_kategori" class="form-control" 
                ...
                <?php if(isset($kategori_wisata) && is_array($kategori_wisata)): ?>
                  <?php foreach($kategori_wisata as $kategori): ?>
                    <option value="<?= $kategori->id_kategori ?>" <?= set_select('id_kategori', $kategori->id_kategori) ?>>
            ...
            <div class="mb-4">
              ...
              <select name="id_kecamatan" class="form-control" 
                ...
                <?php foreach($kecamatan as $k): ?>
                  <option value="<?= $k->id_kecamatan ?>" <?= set_select('id_kecamatan', $k->id_kecamatan) ?>>
            ...
            <div class="mb-4">
              ...
              <input type="number" name="jumlah_karyawan" class="form-control" 
                     value="<?= set_value('jumlah_karyawan', 0) ?>" 
                     style="border:1px solid #c8e6e3; border-radius:8px; padding:10px 12px; transition:0.3s;"
                     placeholder="0"
                     min="0"
                     onfocus="this.style.borderColor='#20c997'; this.style.boxShadow='0 0 0 2px rgba(32, 201, 151, 0.1)';"
          ...
          <div class="col-12">
            <div class="mb-4">
              ...
              <textarea name="alamat" class="form-control" 
                        ...
                        placeholder="Masukkan alamat lengkap wisata"
                        required
                        onfocus="this.style.borderColor='#20c997'; this.style.boxShadow='0 0 0 2px rgba(32, 201, 151, 0.1)';"
                        onblur="this.style.borderColor='#c8e6e3'; this.style.boxShadow='none';"><?= set_value('alamat') ?></textarea>
            </div>
          </div>
        </div>
                      ...
                      <div class="col-md-3 mb-3">
                        <div class="form-check p-2 rounded" style="transition:0.3s; border:1px solid #e3f2fd;">
                          <input class="form-check-input" type="checkbox" 
                                 ...
                                 <?= set_checkbox('fasilitas[]', $f->id_fasilitas) ?>
        ...
        <div class="alert alert-info border-0 mb-4" style="background:#e3f2fd; border-radius:10px; border-left:4px solid #2196f3;">
          <div class="d-flex align-items-center">
            ...
            <div>
              ...
              <small class="text-muted d-block">Pastikan data yang dimasukkan sudah benar sebelum disimpan.</small>
            </div>
          </div>
        </div>
